...
export const NavComp = () => <S><circle cx='12' cy='12' r='9' /><circle cx='12' cy='12' r='5' /><path d='M12 3v3M12 18v3M3 12h3M18 12h3M16.9 4.7l-1.5 2.6M8.6 16.7l-1.5 2.6M4.7 7.1l2.6 1.5M16.7 15.4l2.6 1.5' /></S>;
